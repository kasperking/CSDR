...
#define BPF_SRCLK_Pin GPIO_PIN_4
#define BPF_SRCLK_GPIO_Port GPIOA
#define BPF_RCLK_Pin GPIO_PIN_5
#define BPF_RCLK_GPIO_Port GPIOA
#define BPF_OE_Pin GPIO_PIN_6
#define BPF_OE_GPIO_Port GPIOA
#define BPF_SER_Pin GPIO_PIN_7
#define BPF_SER_GPIO_Port GPIOA
