...
void PeriphCommonClock_Config(void)
{
  ...
  */
  ...
  PeriphClkInitStruct.PLL2.PLL2P = 59;
...
/**
  * @brief TIM8 Initialization Function — LCD backlight PWM (TIM8_CH4, PC9)
  * @param None
  * @retval None
  */
static void MX_TIM8_Init(void)
...
/**
  * @brief TIM17 Initialization Function — fan PWM (TIM17_CH1, PB9)
  * @param None
  * @retval None
  */
static void MX_TIM17_Init(void)
...
static void MX_FMC_Init(void)
{
  ...
  */
  ...
  hsram1.Init.MemoryDataWidth = FMC_NORSRAM_MEM_BUS_WIDTH_16;  /* hw_config: 16BIT */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : ATT_DAT_Pin ATT_CLK_Pin */
  GPIO_InitStruct.Pin = ATT_DAT_Pin|ATT_CLK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : ATT_LATCH_Pin T_R_SW_Pin */
  GPIO_InitStruct.Pin = ATT_LATCH_Pin|T_R_SW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
