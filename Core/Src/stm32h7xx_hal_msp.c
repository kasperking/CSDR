...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    */
    ...
    GPIO_InitStruct.Pin = VOLTAGE_IN_METER_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(VOLTAGE_IN_METER_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PC1     ------> ADC2_INP11
    */
    GPIO_InitStruct.Pin = ALC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ALC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(VOLTAGE_IN_METER_GPIO_Port, VOLTAGE_IN_METER_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PC1     ------> ADC2_INP11
    */
    HAL_GPIO_DeInit(ALC_GPIO_Port, ALC_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    */
    ...
    /* I2C1 is open-drain — pull-up required. Internal ~40 kΩ is safe here;
     * if external resistors are fitted they will dominate. MEDIUM speed
     * avoids ringing on long PCB traces at 400 kHz. */
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    /* Same rationale as I2C1 (PCA9555/INA226 don't need fast edges): MEDIUM
     * avoids unnecessary ringing/EMI on PCB traces at 400 kHz. */
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  if(htim_encoder->Instance==TIM3)
  {
    ...
    PB4 (NJTRST)  ------> TIM3_CH1  (ENC_CH1)
    PB5           ------> TIM3_CH2  (ENC_CH2)
    */
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM3)
  {
    ...
    PB5           ------> TIM3_CH2  (ENC_CH2)
    */
    HAL_GPIO_DeInit(GPIOB, ENC_CH1_Pin|ENC_CH2_Pin);
